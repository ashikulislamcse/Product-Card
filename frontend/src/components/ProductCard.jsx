...
import image4 from "../assets/Mobile.jpeg";
...
const ProductCard = () => {
  return (
    <>
      <div className="text-center bg-red-400 px-20 py-8">
        <h1 className="font-bold text-3xl">Top Products</h1>
      </div>
      <div className="bg-gray-100 w-full min-h-screen gap-6 flex-wrap flex justify-center items-center overflow-hidden">
        {/* Cart 1 */}
        <div className="w-60 p-2 bg-white rounded-xl transform trasition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl mt-4 mb-4 md:mt-0">
          ...
          <div className="p-2">
            ...
            <p className="text-sm text-gray-600 mt-2 mb-2">
              Timepiece, wristwear, clock, accessory, analog, digital, strap,
              luxury, stylish, functional.
            </p>
          </div>
          <div className="flex items-center justify-center mb-2 gap-2">
            <button className="px-3 py-1 rounded-lg bg-blue-400 hover:bg-blue-500 cursor-pointer font-semibold">
              Buy Now
            </button>
            <button className="px-3 py-1 rounded-lg bg-gray-400 hover:bg-gray-500 cursor-pointer">
        ...
        <div className="w-60 p-2 bg-white rounded-xl transform trasition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl mt-4 mb-4 md:mt-0">
          ...
          <div className="p-2">
            <h2 className="font-bold text-lg mb-2">Watch</h2>
            <span className="text-xl font-semibold">৳. 32000 Taka</span>
            <div className="flex items-center gap-2">
              <span className="text-sm line-through opacity-75">
                ৳. 37000 Taka
              </span>
